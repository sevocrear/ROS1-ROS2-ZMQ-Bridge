...
def serialize_ros2(topic, msg):
    """ROS2 message -> dict for given topic."""
    ...
    raise KeyError(f"serialize_ros2: unsupported topic {topic}")


def deserialize_ros2(topic, d, msg_class):
    """Dict -> ROS2 message for given topic."""
    if topic == "/control_cmd":
    ...
    raise KeyError(f"deserialize_ros2: unsupported topic {topic}")
